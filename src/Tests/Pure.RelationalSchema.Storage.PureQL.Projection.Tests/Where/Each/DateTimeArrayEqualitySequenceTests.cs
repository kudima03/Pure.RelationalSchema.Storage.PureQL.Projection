...
public sealed class DateTimeArrayEqualitySequenceTests
{
    ...
    public void WholeDateTimeArrayEqualityOfTwoEqualLiteralArraysKeepsEveryRow()
    {
        ...
        Query query = new WholeDateTimeArrayEqualityOfTwoEqualLiteralArraysQuery().Value;
    ...
    public void WholeDateTimeArrayEqualityOfFieldAgainstLiteralFailsFast()
    {
        ...
        [
            .. orderRows.Select(order => order.PlacedAt).Reverse(),
        ];

        Query query = new WholeDateTimeArrayEqualityOfFieldAgainstLiteralQuery().Value;
    ...
    public void WholeDateTimeArrayEqualityOfLiteralAgainstFieldFailsFast()
    {
        ...
        Query query = new WholeDateTimeArrayEqualityOfLiteralAgainstFieldQuery().Value;
